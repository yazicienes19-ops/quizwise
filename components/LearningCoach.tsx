          ...
          {forecast ? (
            <>
              ...
              <div className="w-full mt-3 space-y-1 text-left">
                <p className="text-[11px] font-medium" style={{ color: 'var(--ink2)' }}>
              ...
              {showPrognosisInfo && (
                <div className="text-[11px] font-medium mt-2 leading-relaxed text-left space-y-2" style={{ color: 'var(--mute)' }}>
              ...
              {learningScore.dimensions.map(d => (
                <div key={d.key} className="space-y-1">
                  ...
                  {d.score !== null ? (
                    ...
                    <p className="text-[11px] font-medium" style={{ color: 'var(--mute)' }}>{d.hint}</p>
                  )}
                </div>
              ))}
            </div>
