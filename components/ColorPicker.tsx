...
export const ColorPicker: React.FC = () => {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="w-full flex items-center justify-between px-4 py-3 rounded-xl text-[13px] font-semibold text-slate-500 dark:text-slate-400 transition-all"
      ...
      {open && (
        <>
          ...
          >
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-400 mb-3">{t('cp.chooseColor')}</p>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-[11px] font-semibold uppercase text-slate-400 tracking-[0.08em]">{t('settings.customColor')}</span>
            </label>
          </div>
        </>
      )}
