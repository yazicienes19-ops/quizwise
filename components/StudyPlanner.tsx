      ...
      <div className="space-y-4">
        <PageHeader
          ...
          actions={<>
            <button
              ...
              className="px-5 py-2.5 rounded-2xl font-semibold text-[13px] transition-all hover:scale-[1.02] flex items-center gap-2 disabled:opacity-40"
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-2xl font-semibold text-[13px] transition-all"
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-2xl font-semibold text-[13px] transition-all flex items-center gap-2"
              style={{ background: 'var(--bg-sidebar)', color: 'var(--text-main)', border: '1px solid var(--border-color)' }}
            >
              <Smartphone size={14} />
              {t('sp2.syncPhone')}
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            ...
            <div>
              <p className="text-xs font-semibold" style={{ color: spacedEnabled ? 'var(--primary)' : 'var(--text-main)' }}>
          ...
          {spacedEnabled && (
            <button
              ...
              className="px-5 py-3 rounded-2xl text-[13px] font-semibold transition-all hover:scale-105"
        ...
        <div className="flex flex-wrap gap-2 justify-end px-1">
          {examTerms.length > 0 && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-[13px] font-semibold text-slate-400 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-colors"
            >
      ...
      {showExamForm && (
        <div className="max-w-xl mx-auto p-8 bg-[var(--card)] dark:bg-slate-900 rounded-[24px] border border-slate-200 dark:border-slate-800 shadow-3d-raised animate-in zoom-in-95 duration-200">
          ...
          <div className="space-y-3">
            ...
            }} className="w-full bg-rose-500 text-white py-4 rounded-2xl text-[13px] font-semibold hover:bg-rose-600 transition-colors">{t('sp2.saveExam')}</button>
          </div>
        </div>
      )}
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              {(['study', 'reminder'] as const).map(et => (
                <button key={et} onClick={() => setNewEventType(et)} className={`flex-1 py-3 rounded-xl text-[13px] font-semibold transition-all ${newEventType === et ? 'bg-indigo-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
            ...
            }} className="w-full bg-indigo-600 text-white py-4 rounded-2xl text-[13px] font-semibold hover:bg-indigo-700 transition-colors">{t('sp2.saveEvent')}</button>
          </div>
        </div>
      )}
            ...
            {syncUrl && !syncLoading && (
              <>
                ...
                <a
                  ...
                  className="block w-full text-center py-4 rounded-2xl text-[13px] font-semibold transition-all"
                ...
                <div className="pt-2 space-y-3 text-sm" style={{ color: 'var(--text-secondary)' }}>
                  <div>
                    <p className="font-semibold text-xs uppercase tracking-[0.08em] mb-1" style={{ color: 'var(--text-main)' }}>{t('sp2.syncIosTitle')}</p>
                    <p>{t('sp2.syncIosSteps')}</p>
                  </div>
                  <div>
                    <p className="font-semibold text-xs uppercase tracking-[0.08em] mb-1" style={{ color: 'var(--text-main)' }}>{t('sp2.syncAndroidTitle')}</p>
        ...
        <div className="inline-flex bg-slate-100 dark:bg-slate-800/60 rounded-2xl p-1 gap-1">
          {([['monat', t('sp2.month')], ['liste', t('sp2.list')]] as [ViewMode, string][]).map(([mode, label]) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-[13px] font-semibold transition-all ${viewMode === mode ? 'shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                ...
                >
                  ...
                  <div className="space-y-1">
                    {visible.map(item => (
                      ...
                      >
                        {item.isAuto && <span className="text-[11px] font-semibold uppercase tracking-[0.08em] opacity-70">{t('sp2.auto')}</span>}
                    ...
                    {overflow > 0 && (
                      <div className="px-2 py-0.5 text-[11px] font-semibold text-slate-400">
