    ...
    <div style={{ background: '#FBF9F4', color: '#1B2A4A' }}>
      ...
      <section className="max-w-5xl mx-auto px-6 sm:px-8 pt-20 sm:pt-28 pb-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            onClick={() => onAuthClick('register')}
            className="px-8 py-4 rounded-full text-[13px] font-black uppercase tracking-widest text-white shadow-xl hover:scale-105 active:scale-95 transition-all"
            style={{ background: '#1B2A4A' }}
          >
          ...
          <button
            onClick={() => onAuthClick('login')}
            className="px-8 py-4 rounded-full text-[13px] font-black uppercase tracking-widest transition-all hover:opacity-70"
        ...
        <p className="mt-7 text-[11px] uppercase tracking-widest" style={{ color: '#8A8172' }}>
      ...
      <section id="akt1" style={{ background: '#1B2A4A', color: '#FBF9F4', padding: '120px 24px' }} className="sm:px-14">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            <p style={{ ...serif, fontSize: 15, fontWeight: 600, color: '#D9A94E', marginBottom: 18 }}>{t('landing.act1.eyebrow')}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <Reveal style={{ transitionDelay: '90ms' } as React.CSSProperties}>
            <div className="p-8 rounded-[6px] border-2 relative h-full" style={{ borderColor: '#A9772C', background: '#1B2A4A', color: '#FBF9F4' }}>
              ...
              <p className="text-[10px] font-black uppercase tracking-widest mb-1" style={{ color: '#D9A94E' }}>{t('landing.pricing.proSub')}</p>
      ...
      <section className="px-6 sm:px-8 py-28 sm:py-36 text-center">
        <Reveal className="max-w-2xl mx-auto">
          ...
          <button
            onClick={() => onAuthClick('register')}
            className="px-10 py-5 rounded-full text-[13px] font-black uppercase tracking-widest text-white shadow-xl hover:scale-105 active:scale-95 transition-all"
            style={{ background: '#1B2A4A' }}
          >
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8 flex flex-col sm:flex-row justify-between items-center gap-5">
          ...
          <div className="flex gap-6">
            {(['landing.footer.privacy', 'landing.footer.imprint', 'landing.footer.terms'] as TKey[]).map(l => (
              <button key={l} className="text-[11px] font-bold uppercase tracking-widest transition-colors hover:opacity-70" style={{ color: '#8A8172' }}>
                {t(l)}
              </button>
            ))}
          </div>
