...
const DIGEST_CONFIG = {
  pending: { label: 'Wird analysiert …',      dot: 'bg-violet-500 animate-pulse', pill: 'bg-violet-50 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400' },
  ready:   { label: 'Analysiert',             dot: 'bg-violet-500',               pill: 'bg-violet-50 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400' },
  error:   { label: 'Analyse fehlgeschlagen', dot: 'bg-rose-400',                 pill: 'bg-rose-50 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400' },
};
