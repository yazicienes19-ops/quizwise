    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      <div className="text-center space-y-3">
        <h1 className="text-5xl font-black text-slate-900 dark:text-white tracking-tighter">
          Hausarbeit <span className="text-indigo-600 drop-shadow-md">Professional</span> <EmojiImage emoji="🖋️" size={48} />
        </h1>
        ...
        <div className="bg-slate-200/50 dark:bg-slate-900 p-2 rounded-[28px] shadow-3d-pressed border border-white/40 dark:border-slate-800 flex flex-wrap justify-center gap-2">
          {[
            ...
            <button
              ...
              className={`px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${step === tab.id ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-white shadow-3d-raised scale-[1.05]' : 'text-slate-400 opacity-60 hover:opacity-100'}`}
            >
              {tab.label}
            </button>
          ))}
        ...
        {step === 'magic' && (
          <div className="space-y-10 animate-in slide-in-from-bottom-8 duration-500">
            <div className="text-center space-y-4">
               <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-indigo-600">KI-Zitier-Assistent</h3>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              <textarea 
                ...
                className="w-full h-40 p-6 bg-slate-50 dark:bg-slate-800 rounded-[32px] border-2 border-transparent focus:border-indigo-500 outline-none transition-all dark:text-white font-medium"
              />
              <button 
                onClick={handleMagicFormat}
                disabled={isMagicLoading || !magicInput.trim()}
                className="w-full bg-indigo-600 text-white font-black py-5 rounded-2xl text-[12px] uppercase tracking-[0.3em] shadow-xl hover:scale-[1.02] transition-all disabled:opacity-50"
              >
            ...
            {magicResult && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div className="bg-slate-50 dark:bg-slate-800/40 p-8 rounded-[32px] border border-slate-100 dark:border-slate-700 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-white dark:bg-slate-900 rounded-xl border italic text-sm text-slate-700 dark:text-slate-300 relative group">
                      ...
                      <button onClick={() => copyToClipboard(magicResult.apa.entry)} className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 bg-indigo-500 text-white p-1 rounded">
                ...
                {/* MLA Card */}
                <div className="bg-slate-50 dark:bg-slate-800/40 p-8 rounded-[32px] border border-slate-100 dark:border-slate-700 space-y-6">
                  <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase text-indigo-500 tracking-widest">MLA 9th Edition</span></div>
                  <div className="space-y-4">
                    <div className="p-4 bg-white dark:bg-slate-900 rounded-xl border text-sm text-slate-700 dark:text-slate-300 relative group">
                      ...
                      <button onClick={() => copyToClipboard(magicResult.mla.entry)} className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 bg-indigo-500 text-white p-1 rounded">
                        <EmojiImage emoji="📋" size={12} />
                      </button>
                    </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800/40 p-8 rounded-[32px] border border-slate-100 dark:border-slate-700 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-white dark:bg-slate-900 rounded-xl border italic text-sm text-slate-700 dark:text-slate-300 relative group">
                      ...
                      <button onClick={() => copyToClipboard(magicResult.harvard.entry)} className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 bg-indigo-500 text-white p-1 rounded">
                        <EmojiImage emoji="📋" size={12} />
                      </button>
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                ...
                <div className="bg-slate-50 dark:bg-slate-800/40 p-8 rounded-[32px] border border-slate-100 dark:border-slate-700 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-white dark:bg-slate-900 rounded-xl border text-sm text-slate-700 dark:text-slate-300 relative group">
                      ...
                      <button onClick={() => copyToClipboard(magicResult.chicago.bibliography)} className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 bg-indigo-500 text-white p-1 rounded">
                        <EmojiImage emoji="📋" size={12} />
                      </button>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              <div className="space-y-6">
                <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-indigo-600">Arbeit konfigurieren</h3>
                <div className="space-y-4">
                  <input
                    type="text"
                    value={topic}
                    ...
                    className="w-full p-5 bg-slate-50 dark:bg-slate-800 rounded-2xl border-2 border-transparent focus:border-indigo-500 outline-none transition-all dark:text-white font-bold"
                  />
                  <textarea
                    value={focus}
                    onChange={(e) => setFocus(e.target.value)}
                    placeholder="Besonderer Fokus oder Forschungsfrage..."
                    className="w-full p-5 bg-slate-50 dark:bg-slate-800 rounded-2xl border-2 border-transparent focus:border-indigo-500 outline-none transition-all h-32 dark:text-white resize-none"
                  />
                </div>
              </div>
              <button
                ...
                className="w-full bg-indigo-600 text-white font-black py-5 rounded-2xl text-[12px] uppercase tracking-[0.3em] shadow-xl hover:bg-indigo-700 transition-all disabled:opacity-50"
              >
              ...
              <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 scrollbar-thin">
                {availableDocuments.map(doc => (
                  <div 
                    ...
                    className={`flex items-center gap-4 p-5 rounded-2xl border-2 transition-all cursor-pointer ${selectedDocIds.includes(doc.id) ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-950/20 shadow-inner' : 'border-slate-100 dark:border-slate-800 bg-slate-50/50'}`}
                  >
                    <div className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center ${selectedDocIds.includes(doc.id) ? 'bg-indigo-500 border-indigo-500 text-white' : 'border-slate-300'}`}>
        ...
        {step === 'planner' && (
          <div className="max-w-4xl mx-auto space-y-10 animate-in slide-in-from-right-12 duration-700">
            <div className="flex justify-between items-center pb-6 border-b border-slate-100 dark:border-slate-800">
              ...
              <button onClick={() => setStep('setup')} className="text-[10px] font-black uppercase text-slate-400 hover:text-indigo-600">← Zurück</button>
            </div>
            <div className="space-y-6">
              {outline.map((section, idx) => (
                <div key={idx} className="p-8 bg-slate-50 dark:bg-slate-800/50 rounded-[32px] border border-slate-100 dark:border-slate-800 group hover:border-indigo-500/40 transition-all">
                  <div className="flex gap-6">
                    <div className="w-12 h-12 bg-indigo-600 text-white rounded-2xl flex items-center justify-center font-black text-xl flex-shrink-0 shadow-lg">{idx + 1}</div>
        ...
        {step === 'citations' && (
          <div className="space-y-12 animate-in slide-in-from-right-12 duration-700">
            <div className="flex flex-col items-center gap-8 text-center">
              <div className="space-y-4">
                <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-indigo-600">Schritt 1: Zitierstil wählen</h3>
                <div className="flex flex-wrap justify-center gap-3 bg-slate-100 dark:bg-slate-800 p-2 rounded-3xl shadow-inner">
                  {(['APA', 'MLA', 'Harvard', 'Chicago'] as CitationStyle[]).map(style => (
                    <button
                      ...
                      className={`px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all ${citationStyle === style ? 'bg-white dark:bg-slate-700 text-indigo-600 dark:text-white shadow-lg' : 'text-slate-400 hover:text-slate-600'}`}
                    >
                      {style}
                    </button>
                  ))}
              ...
              <div className="w-full max-w-4xl bg-slate-50 dark:bg-slate-800/40 rounded-[40px] p-6 sm:p-10 border border-slate-100 dark:border-slate-800 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <input 
                    ...
                    className="p-4 bg-white dark:bg-slate-900 rounded-2xl border-none outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm dark:text-white"
                  />
                  <input 
                  ...
                  <input 
                    ...
                    className="p-4 bg-white dark:bg-slate-900 rounded-2xl border-none outline-none focus:ring-2 focus:ring-indigo-500 shadow-sm dark:text-white md:col-span-2"
                  />
                </div>
                <button 
            ...
            <div className="space-y-8 max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-6">
                {sources.map(s => (
                  <div key={s.id} className="p-8 bg-white dark:bg-slate-900 border-2 border-slate-50 dark:border-slate-800 rounded-[32px] relative group hover:border-indigo-400 transition-all shadow-3d-raised">
                    <div className="flex justify-between items-start mb-4">
                      <span className="text-[9px] font-black uppercase tracking-widest text-indigo-600 bg-indigo-50 dark:bg-indigo-950/30 px-3 py-1 rounded-lg">{citationStyle} Standard</span>
                    ...
                    <div className="relative group/citation">
                      ...
                      <button 
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white dark:bg-slate-700 text-indigo-600 px-4 py-2 rounded-xl text-[9px] font-black uppercase shadow-md border hover:bg-indigo-600 hover:text-white transition-all"
                      >Kopieren</button>
                    </div>
                  </div>
                ))}
